...
<form action="{{ $product->exists ? route('merchant.products.update', $product) : route('merchant.products.store') }}"
    ...
    {{-- Step 1 --}}
    <div x-show="step === 1" x-cloak class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6 space-y-4 pb-24">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div class="md:col-span-2" data-description-ai>
                ...
                <div id="quill-editor"
                     data-generate-url="{{ route('merchant.products.generate-description') }}"
    ...
    {{-- Step 2 --}}
    <div x-show="step === 2" x-cloak class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6 space-y-4 pb-24">
        ...
        <div>
            ...
            <textarea name="image_urls" rows="3" class="input-field text-sm"
                placeholder="https://images.unsplash.com/photo-...">{{ old('image_urls', request('design_image')) }}</textarea>
        </div>
    ...
    {{-- Step 3 --}}
    <div x-show="step === 3" x-cloak class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6 space-y-4 pb-24">
            ...
            <div class="space-y-2 rounded-lg bg-gray-50 p-3">
                <div class="grid grid-cols-2 gap-3 md:grid-cols-4 lg:grid-cols-7">
                    ...
                    <div class="flex gap-1">
                        ...
                        <button type="button" @click="variants.splice(i,1)" class="px-2 text-red-500" x-show="variants.length > 1">×</button>
                    </div>
                </div>
    ...
    {{-- Step 4 --}}
    <div x-show="step === 4" x-cloak class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6 space-y-4 pb-24">
    ...
    {{-- Step 5 --}}
    <div x-show="step === 5" x-cloak class="bg-white rounded-xl shadow-sm ring-1 ring-gray-200 p-6 space-y-4 pb-24">
        <div>
    ...
    <div class="sticky bottom-0 z-20 -mx-4 lg:-mx-6 mt-4 border-t bg-white/95 backdrop-blur px-4 lg:px-6 py-3">
        <div class="flex gap-2 max-w-full">
            ...
            <button type="button" x-show="step === 2" @click="step = 3" class="btn-primary h-10 px-6 text-sm">Next: Variants</button>
            <button type="button" x-show="step === 3" @click="step = 4" class="btn-primary h-10 px-6 text-sm">Next: Attributes</button>
            <button type="button" x-show="step === 4" @click="step = 5" class="btn-primary h-10 px-6 text-sm">Next: SEO</button>
